...
def _guard_sql(sql_text: str) -> str:
    # Enforce read-only, single statement, no comments
...
def _infer_chart(columns: List[str], rows: List[List[Any]]) -> Dict[str, Any]:
    ...
    # Simple heuristic: if first column looks categorical and there are 1-3 numeric columns -> bar
